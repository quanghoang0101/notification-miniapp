...
import com.walmartlabs.ern.container.miniapps.NotificationMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = NotificationMiniappActivity.class;
